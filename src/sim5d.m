%SIMULACION DEL THETA METHOD CON CONDICIONES DEL EJERCICIO 5d%
%PARAMETROS%
theta = 0.75;
N = 500;
deltaT = 0.002;
...
title("Evolución del perfil de temperaturas de la barra utilizando el ThetaMetodo con theta=3/4");
colorbar();
